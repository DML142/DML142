...
18, full-stack developer working remotely out of Ukraine. About a year and a half hands-on with Node.js — enough to take a real-time, fully-authenticated SaaS platform from an empty repo to a working system in roughly a month.

Learned the fundamentals — architecture, design patterns — by writing everything myself first, no AI involved. These days AI-assisted coding speeds up the routine parts and cuts boilerplate, but every architecture and stack decision is still mine, and I can read and review whatever an agent produces rather than depend on it.
...
<div align="center">
<img src="https://skillicons.dev/icons?i=nextjs,react,ts,tailwind,nestjs,prisma,postgres,redis,docker,githubactions,threejs,figma" />
</div>
...
### [dml-central — this portfolio](https://dml-central.dev)
`Next.js` `Three.js` `R3F` `GSAP` `Playwright`
...
### [DML's Solutions](https://github.com/DML142/dmls-solutions) — *archived*
